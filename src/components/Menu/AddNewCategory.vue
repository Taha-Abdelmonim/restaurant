  ...
  <div class="container">
    ...
    <form @click.prevent>
      ...
      <div class="row g-3 align-items-center mb-3">
        <div class="col-auto d-block mx-auto">
          <button type="button" @click="addCategory()" class="w250 btn btn-success">Add Now</button>
        </div>
      </div>
      <div class="row g-3 align-items-center mb-3">
        ...
        <div class="col-auto d-block mx-auto alert alert-danger mb-3" v-if="errorMessage.length > 0">
          {{ errorMessage }}
        </div>
      </div>
      <br />
    ...
    async addCategory() {
      ...
      if (!this.v$.$error) {
        if (filterCategoryName.length > 0) {
          ...
          let result = await axios.post(`https://fake-jsonapi.herokuapp.com/categories`, {
            name: this.name,
            userId: this.userId,
