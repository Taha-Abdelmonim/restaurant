    ...
    <form @click.prevent>
      ...
      <div class="row g-3 align-items-center">
        <div class="col-auto mx-auto d-block">
          ...
          <p class="text-danger">When Deleting this items, you will no longer see them...</p>
          <hr />
        </div>
      </div>
      <div class="row g-3 align-items-center">
        <div class="col-auto mx-auto d-block">
          ...
          &nbsp;&nbsp;&nbsp;
          <button class="btn btn-danger" @click="deleteAllItems()">Delete Now</button>
        </div>
      </div>
      <br />
      <div class="row g-3 align-items-center">
...
export default {
  ...
  async mounted() {
    ...
    if (!user) {
      ...
      let result = await axios.get(`https://fake-jsonapi.herokuapp.com/items?userId=${this.userId}&locId=${this.locationId}`);
