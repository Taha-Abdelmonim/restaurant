<template>
  <form @click.prevent>
    <div class="row g-3 align-items-center">
      <div class="col-auto d-block mx-auto">
        ...
        <div class="form-floating mb-3" :class="{ 'form-group-error': v$.name.$error }">
          <input type="text" class="w250 form-control" id="floatNameIs" placeholder="Your Name Is" v-model.trim="name" />
    ...
    <div class="row g-3 align-items-center">
      <div class="col-auto d-block mx-auto">
        <div class="form-floating mb-3" :class="{ 'form-group-error': v$.email.$error }">
          <input type="email" class="w250 form-control" id="floatEmailIs" placeholder="Your Email Is" v-model.trim="email" />
    ...
    <div class="row g-3 align-items-center">
      <div class="col-auto d-block mx-auto">
        <div class="form-floating mb-3" :class="{ 'form-group-error': v$.pass.$error }">
          <input type="password" class="w250 form-control" id="floatPassIs" placeholder="Your Password Is" v-model.trim="pass" />
    ...
    <div class="row g-3 align-items-center mb-3">
      <div class="col-auto d-block mx-auto">
        <button type="submit" @click="validateEmailBeforeSignUp()" class="w250 btn btn-success">Sign Up Now</button>
      </div>
    </div>
    <div class="row g-3 align-items-center mb-3">
      <div class="col-auto d-block mx-auto">
        <button type="button" @click="redirectTo({ val: 'Login' })" class="w250 btn btn-primary">Login</button>
      </div>
    </div>
    <div class="row g-3 align-items-center">
...
export default {
  ...
  methods: {
    ...
    async validateEmailBeforeSignUp() {
      let res = await axios.get(`https://fake-jsonapi.herokuapp.com/users?email=${this.email}`);
      if (res.status == 200) {
    ...
    async signUpNow() {
      ...
      if (!this.v$.$error) {
        ...
        let result = await axios.post("https://fake-jsonapi.herokuapp.com/users", {
          name: this.name,
          email: this.email,
          pass: this.pass,
        });
